...
func NewDeletePetRequest(server string, petId int64, params *DeletePetParams) (*http.Request, error) {
	...
	pathParam0, err = runtime.StyleParamWithOptions("simple", false, "petId", petId, runtime.StyleParamOptions{ParamLocation: runtime.ParamLocationPath, Type: "integer", Format: "int64"})
	if err != nil {
		return nil, err
	}
	...
	if params != nil {
		...
		if params.ApiKey != nil {
			...
			headerParam0, err = runtime.StyleParamWithOptions("simple", false, "api_key", *params.ApiKey, runtime.StyleParamOptions{ParamLocation: runtime.ParamLocationHeader, Type: "string", Format: ""})
			if err != nil {
				return nil, err
			}
...
func NewUploadFileRequestWithBody(server string, petId int64, params *UploadFileParams, contentType string, body io.Reader) (*http.Request, error) {
	...
	if params != nil {
		...
		if params.AdditionalMetadata != nil {
			...
			if queryFrag, err := runtime.StyleParamWithOptions("form", true, "additionalMetadata", *params.AdditionalMetadata, runtime.StyleParamOptions{ParamLocation: runtime.ParamLocationQuery, Type: "string", Format: ""}); err != nil {
				return nil, err
			} else if parsed, err := url.ParseQuery(queryFrag); err != nil {
				return nil, err
			} else {
