...
func NewBookPageDocument(entity *entities.BookPage) (BookPageDocument, error) {
...
func (document *BookPageDocument) ToEntity() entities.BookPage {
	return entities.BookPage{
		ID:         document.ID.Hex(),
