...
func (_mock *MockUserRepository) CreateUser(ctx context.Context, user *entity.User) (string, error) {
	...
	var r0 string
	var r1 error
	if returnFunc, ok := ret.Get(0).(func(context.Context, *entity.User) (string, error)); ok {
		return returnFunc(ctx, user)
	}
	if returnFunc, ok := ret.Get(0).(func(context.Context, *entity.User) string); ok {
...
func (_c *MockUserRepository_CreateUser_Call) Return(s string, err error) *MockUserRepository_CreateUser_Call {
	_c.Call.Return(s, err)
	return _c
}

func (_c *MockUserRepository_CreateUser_Call) RunAndReturn(run func(ctx context.Context, user *entity.User) (string, error)) *MockUserRepository_CreateUser_Call {
	_c.Call.Return(run)
	return _c
}
